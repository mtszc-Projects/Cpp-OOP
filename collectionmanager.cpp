...
void CollectionManager::manage(){
    ...
    while (wybor != 11){
        ...
        std::cout << "8.  Usun przedmiot z kolekcji."; std::cout << std::setw(34) << "(nacisnij:  8)" << std::endl;
        std::cout << "9.  Usun kolekcji."; std::cout << std::setw(46) << "(nacisnij:  9)" << std::endl;
        std::cout << "10. Pokaz statystyki przedmiotow."; std::cout << std::setw(31) << "(nacisnij: 10)" << std::endl;
